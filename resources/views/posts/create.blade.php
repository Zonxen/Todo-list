...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center flex-col">
    ...
    <div class="flex flex-col min-h-screen w-full max-w-5xl">
        <form class="gap-4 flex flex-col" method="POST" action="{{ route('posts.store') }}">
            ...
            <div>
                <textarea class="mt-4 text-xl font-serif w-full h-auto resize-none field-sizing-content" type="text" name="content" placeholder="Tell your story..." required></textarea>
            </div>
            <div>
